...
1. Users
   - The user model stores the following attributes:
     ...
     3. `email`: This is the email entered by the user. It is unique, as there should only be one account associated with each email.
     4. `password_hash`: This is a hashed password. We store a hash instead of the actual password to prevent the password from being exposed in the database.
     5. `role`: This is the role of the user. It can be either `admin` or `user`.
     6. `created_at`: This is the date and time when the user was created. It is auto-generated by the database.
     7. `updated_at`: This is the date and time when the user was last updated. It is auto-generated by the database.
2. Sessions
...
1. `_id`: This is the primary key for the user collection. It is an ObjectId, auto-generated by MongoDB.
2. `username`: This is the username selected by the user. It is unique, in order to prevent confusion on the client-side.
...
The core service has a [PostgreSQL](https://www.postgresql.org/) database with a number of related tables:

1. `projects`: This table stores the details of projects, and has the following attributes:
   1. `id`: This is the primary key for the project table. It is an auto-incrementing integer.
   2. `name`: This is the name of the project.
   3. `created_by`: This is a "foreign key" that references the `_id` attribute in the `user` collection in the user service's MongoDB database. It references the user who created the project.
   4. `created_at`: This is the date and time when the project was created. It is auto-generated by the database.
   5. `updated_at`: This is the date and time when the project was last updated.
2. `onboardings`: This table stores the details of user assignments to projects, and has the following attributes:
   1. `project`: This is a foreign key that references the `id` column in the project table.
   2. `user`: This is a "foreign key" that references the `_id` attribute in the `user` collection in the user service's MongoDB database.
   3. `role`: This is the role of the user. It is an enumeration that can be either `admin` or `user`.
   4. `created_at`: This is the date and time when the onboarding was created. It is auto-generated by the database.
   5. `updated_at`: This is the date and time when the onboarding was last updated.
3. `todos`: This table stores the details of tasks, and has the following attributes:
   1. `id`: This is the primary key for the todo table. It is an auto-incrementing integer.
   2. `project`: This is a foreign key that references the `id` column in the project table.
   3. `created_by`: This is a "foreign key" that references the `_id` attribute in the `user` collection in the user service's MongoDB database. It references the user who created the task.
   4. `title`: This is the name of the task. It is unique to the project, in order to prevent confusion on the client-side.
   5. `description`: This is a description of the task.
   6. `status`: This is the status of the task. It is an enumeration that can be either `to_do`, `in_progress`, or `completed`.
   7. `created_at`: This is the date and time when the task was created. It is auto-generated by the database.
   8. `updated_at`: This is the date and time when the task was last updated. It is auto-generated by the database.
4. `assignments`: This table stores the details of user assignments to tasks, and has the following attributes:
   1. `todo`: This is a foreign key that references the `id` column in the todo table.
   2. `user`: This is a "foreign key" that references the `_id` attribute in the `user` collection in the user service's MongoDB database.
   3. `created_at`: This is the date and time when the assignment was created. It is auto-generated by the database.
   4. `updated_at`: This is the date and time when the assignment was last updated.
5. `comments`: This table stores the details of comments made under tasks, and has the following attributes:
   1. `id`: This is the primary key for the comment table.
   2. `todo`: This is a foreign key that references the `id` column in the todo table.
   3. `author`: This is a "foreign key" that references the `_id` attribute in the `user` collection in the user service's MongoDB database. It references the user who made the comment.
   4. `content`: This is the content of the comment.
   5. `created_at`: This is the date and time when the comment was created. It is auto-generated by the database.
   6. `updated_at`: This is the date and time when the comment was last updated.

#### Notification Service

The notification service has a [PostgreSQL](https://www.postgresql.org/) database with a two related tables. The tables are as follows:

1. `notifications`: This table stores the details of notifications, and has the following attributes:
   1. `id`: This is the primary key for the notification table. It is an auto-incrementing integer.
   2. `title`: This is the title of the notification.
   3. `content`: This is the content of the notification.
   4. `href`: This is link to the resource that the notification is about.
   5. `created_at`: This is the date and time when the notification was created.
   6. `updated_at`: This is the date and time when the notification was last updated.
2. `statuses`: This table stores the details of notification statuses, and has the following attributes:
   1. `user`: This is a "foreign key" that references the `_id` attribute in the `user` collection in the user service's MongoDB database.
   2. `notification`: This is a foreign key that references the `id` column in the notification table.
   3. `read`: This is a boolean value that indicates whether the notification has been read or not.
   4. `created_at`: This is the date and time when the notification status was created.
   5. `updated_at`: This is the date and time when the notification status was last updated.
