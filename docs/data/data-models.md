...
1. `projects`: This table stores the details of projects, and has the following attributes:
   ...
   3. `created_at`: This is the date and time when the project was created. It is auto-generated by the database.
   4. `updated_at`: This is the date and time when the project was last updated.
